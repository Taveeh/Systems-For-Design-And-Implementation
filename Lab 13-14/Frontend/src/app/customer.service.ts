...
export class CustomerService {
  ...
  update(customer: Customer): Observable<Customer> {
    ...
    return this.httpClient.put<Customer>(url, {name: customer.name, phoneNumber: customer.phoneNumber}).pipe(
  ...
  add(customer: Customer): Observable<any> {
    ...
    return this.httpClient.post<any>(this.customerUrl, {name: customer.name, phoneNumber: customer.phoneNumber}).pipe(
